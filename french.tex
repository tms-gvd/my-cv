...
\section{Expérience en recherche}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Supervisé par Claire Chainais et Andrea Natale.}
      \resumeItem{Sujet : "Étude de modèles dynamiques type cellules de Voronoï".}
      \resumeItem{Etude théorique et numérique d'un problème d'optimisation convexe.}
    \resumeItemListEnd

    \resumeSubheading
      {IAE Lille}{Lille, France}
      {Thèse de Master, Finance Quantitative et Machine Learning}{Octobre 2022 \textbf{--} Avril 2023}
      \resumeItemListStart
      \resumeItem{Travail en binôme, supervisé par Philippe Heinrich.}
      \resumeItem{Sujet : "Pricing via régression par processus gaussien".}
      \resumeItem{Etude théorique de la régression par processus gaussien.}
      \resumeItem{Application à des problématiques de finance quantitative (pricing d'options américaines par exemple).}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Supervisé par Michael Perrot.}
      \resumeItem{Sujet : "Fairness in Federated Learning".}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          Valorisation de leurs données grâce à des modèles de prédictions.}
